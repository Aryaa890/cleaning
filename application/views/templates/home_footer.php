<footer class="gap no-bottom" style="background-image:url(<?= base_url('assets/'); ?>img/footer.jpg)">
    <div class="container">
        <div class="row">
        ...
        <div class="form-box">
            ...
            <form id="pickup-form" method="post">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <input type="text" name="no_handphone" id="no_handphone" placeholder="Phone No">
                    </div>
                    <div class="col-lg-12">
